<%-- 
    ...
    Created on : 22 Aug, 2023, 11:40:31 AM
    Author     : Dell
--%>
            ...
            <div class="container">
                ...
                <div class="col-md-6 offset-md-3">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header text-center primary-backgroung text-white">
                        ...
                        <div class="card-body">
                            <form id="reg-form" action="RegisterServlet" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="user_name" type="test" class="form-control" id="user_name" aria-describedby="emailHelp" placeholder="Enter name">
                                </div>
