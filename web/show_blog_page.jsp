...
<%@page import="com.presional.dao.UserDao"%>
<%@page import="java.util.ArrayList"%>
<%@page import="com.presional.entities.Category"%>
...
<html>
    ...
    <div id="fb-root"></div>
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v18.0" nonce="4LI5JQRU"></script>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark primary-backgroung">
        <a class="navbar-brand" href="index.jsp"><span class ="fa fa-asterisk"></span> Tech-Gyan</a>
        ...
        <div class="row my-4">
            ...
            <div class="col-md-8 offset-md-2">
                ...
                <div class="card">
                    ...
                    <div class="card-header primary-backgroung text-white">
                    ...
                    <div class="card-footer primary-backgroung">
                    ...
                    <div class="card-footer">
                        <div class="fb-comments" data-href="http://localhost:8084/Presional_Project/show_blog_page.jsp?post_id=<%= p.getPid()%>" data-width="" data-numposts="5"></div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header primary-backgroung text-white text-center">
                    <h5 class="modal-title" id="exampleModalLabel">Tech-Gyan</h5>
                ...
                <div class="modal-body">
                    <div class="container text-center">
                        ...
                        <div id="profile-edit" style="display: none;">
                            <h3 mt-2>Please Edit Carefully</h3>
